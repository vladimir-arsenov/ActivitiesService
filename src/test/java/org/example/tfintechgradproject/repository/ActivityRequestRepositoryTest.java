...
public class ActivityRequestRepositoryTest {
    ...
    public void getClosest_basedOnRadiusAndCoordinates_shouldReturnClosestActivityRequests() throws ParseException {
        ...
        var closestActivityRequests = repository.findClosestAndActive(activity.getId(), "POINT(13.13 2.0)", ONE_DEGREE_OF_LATITUDE_IN_KM);
        ...
        closestActivityRequests = repository.findClosestAndActive(activity.getId(), "POINT(13.13 2.0)", ONE_DEGREE_OF_LATITUDE_IN_KM-2000);
